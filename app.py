...
page = st.sidebar.radio(
    "Navigate",
    ["Overview", "Dataset", "Training", "Evaluation", "Live classifier", "Model card"],
)
...
# --------------------------------------------------------------------------- #
    ...
    if model_dir is None:
        st.info(
            "To run live predictions, upload these from the sidebar: "
            + ", ".join(f"`{m}`" for m in missing)
            + ".\n\nAlso make sure the inference packages are installed:\n\n"
