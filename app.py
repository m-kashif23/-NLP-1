...
if page == "🏠 Home":
    ...
    st.info(
        "**Research Objective 2:** Integrate model into accountability "
        "dashboard to support **SDG 16** via visualizing complaint patterns "
        "and identifying high-risk institutions.",
        icon="🎯",
    )
